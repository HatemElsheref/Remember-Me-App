...
@section('content')
    ...
    <!-- Page Heading -->
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <div>
                <h1 class="h3 mb-0 text-gray-800"><small class="badge badge-success text-sm-center ">Edit Broadcast Job</small></h1>
        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-md-12 mb-4">
                <form autocomplete="off" method="post" action="{{route('broadcast.update',$job->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
            ...
            <div class="col-xl-6 col-md-12 mb-4">
           <div>
               <img src="{{asset('uploads/'.$job->file)}}"  style="width: 300px;height: 300px; object-fit: cover">
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
