...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <div>
                    <h1 class="h3 mb-0 text-gray-800"><small class="badge badge-primary text-sm-center ">Add Daily Job</small></h1>
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-md-12 mb-4">
                    <form autocomplete="off" method="post" action="{{route('job.store.daily')}}">
                        @csrf
