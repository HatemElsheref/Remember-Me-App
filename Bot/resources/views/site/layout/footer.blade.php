            ...
            <div class="col-lg-12">
                <div class="footer_top flex-column">
                    <div class="footer_logo">
                        <a href="#">
                            <img src="{{asset('site/assets/img/logo2.png')}}" alt="">
                        </a>
...
<script src="{{asset('site/assets/js/stellar.js')}}"></script>
<script src="{{asset('site/assets/vendors/isotope/imagesloaded.pkgd.min.js')}}"></script>
<script src="{{asset('site/assets/vendors/isotope/isotope-min.js')}}"></script>
